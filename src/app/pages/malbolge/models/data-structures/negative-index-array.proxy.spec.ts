import { ArrayProxy, ReadonlyArrayProxy } from './negative-index-array.proxy';
...
describe('Negative Index Array Proxies', () => {
	...
	describe('Array Proxy', () => {
		it('should get [0] at [0]', () => {
			...
			const arrayProxy: Array<string> = ArrayProxy(array);
	...
	describe('Readonly Array Proxy', () => {
		it('should get [0] as [0]', () => {
			...
			const arrayProxy: ReadonlyArray<string> = ReadonlyArrayProxy(array);
			expect(arrayProxy[0]).toBe('a');
		});
